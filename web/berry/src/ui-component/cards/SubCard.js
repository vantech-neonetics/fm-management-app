...
SubCard.propTypes = {
  ...
  title: PropTypes.oneOfType([PropTypes.node, PropTypes.string, PropTypes.object]),subTitle: PropTypes.oneOfType([PropTypes.node, PropTypes.string, PropTypes.object])
};
