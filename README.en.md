...
[![license](https://img.shields.io/github/license/songquanpeng/one-api?color=brightgreen)](https://raw.githubusercontent.com/songquanpeng/one-api/main/LICENSE)
[![release](https://img.shields.io/github/v/release/songquanpeng/one-api?color=brightgreen&include_prereleases)](https://github.com/songquanpeng/one-api/releases/latest)
[![docker pull](https://img.shields.io/docker/pulls/justsong/one-api?color=brightgreen)](https://hub.docker.com/repository/docker/justsong/one-api)
[![release](https://img.shields.io/github/downloads/songquanpeng/one-api/total?color=brightgreen&include_prereleases)](https://github.com/songquanpeng/one-api/releases/latest)
[![GoReportCard](https://goreportcard.com/badge/github.com/songquanpeng/one-api)](https://goreportcard.com/report/github.com/songquanpeng/one-api)
...
> **Warning**: This README is translated by ChatGPT. Please feel free to submit a PR if you find any translation errors.> **Warning**: The Docker image for the English version is `justsong/one-api-en`.
...
14. Offers rich **customization** options:
    1. Supports customization of system name, logo, and footer.### Features
...
Refer to [#175](https://github.com/songquanpeng/one-api/issues/175) for detailed instructions.If you encounter a blank page after deployment, refer to [#97](https://github.com/songquanpeng/one-api/issues/97) for possible solutions.
...
7. Select Redeploy.
8. In the Domains tab, select a suitable domain name prefix, such as "my-one-api". The final domain name will be "my-one-api.zeabur.app". You can also CNAME your own domain name.## Configuration
